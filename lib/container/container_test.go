...
func TestNew(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				envVars: map[string]string{
					envconstant.DBMaxIdleEnvVar:     "10",
					envconstant.DBMaxOpenEnvVar:     "100",
					envconstant.DBMaxLifeTimeEnvVar: "3600",
					envconstant.DBMaxIdleTimeEnvVar: "600",
					envconstant.DatabaseURLEnvVar:   os.Getenv(envconstant.DatabaseURLEnvVar),
					envconstant.GormConf:            "../../config/gorm-logger-config.json",
					envconstant.ZapConf:             "../../config/zap-logger-config.json",
					envconstant.PortEnvVar:          "8080",
					envconstant.PprofEnable:         "true",
					envconstant.DBEnvVar:            "postgres",
				},
			},
			want: &container{
				environmentVariables: map[string]string{
...
func Test_container_dbSetup(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				environmentVariables: map[string]string{
					...
					envconstant.DBMaxIdleTimeEnvVar: "600",
					envconstant.DatabaseURLEnvVar:   os.Getenv(envconstant.DatabaseURLEnvVar),
					envconstant.GormConf:            "../../config/zap-logger-config.json",
					envconstant.DBEnvVar:            "postgres",
				},
				db: nil,
			},
		...
		},
		{
			...
			fields: fields{
				environmentVariables: map[string]string{
					...
					envconstant.DBMaxLifeTimeEnvVar: "3600",
					envconstant.DBMaxIdleTimeEnvVar: "600",
					envconstant.DatabaseURLEnvVar:   "test_db_url",
					envconstant.GormConf:            "../../config/zap-logger-config.json",
					envconstant.DBEnvVar:            "postgres",
				},
				db: nil,
		...
		},
		{
			...
			fields: fields{
				environmentVariables: map[string]string{
					envconstant.DBMaxIdleEnvVar:     "invalid",
					envconstant.DBMaxOpenEnvVar:     "100",
					envconstant.DBMaxLifeTimeEnvVar: "3600",
					envconstant.DBMaxIdleTimeEnvVar: "600",
					envconstant.DatabaseURLEnvVar:   "test_db_url",
